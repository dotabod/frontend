...
const validateToken = async function validateToken(accessToken: string) {
...
const refreshToken = async function refreshToken(refreshToken: string) {
...
export const getTwitchTokens = async function getTwitchTokens(userId: string) {
  try {
