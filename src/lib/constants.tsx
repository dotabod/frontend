...
export const APRIL_2024_MSG = (track: ReturnType<typeof useTrack>): ArgsProps => ({
  key: 'important-update',
  type: 'error',
  duration: 0,
  placement: 'bottomLeft',
  message: 'Important Update for users who signed up between April 6 2024 and October 14 2024',
  btn: (
    <Button
      target='_blank'
