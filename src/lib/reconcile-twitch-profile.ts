...
const fetchHelix = async function fetchHelix(accessToken: string): Promise<HelixUser | null> {
  try {
...
export const reconcileTwitchProfile = async function reconcileTwitchProfile({
  prisma,
  userId,
  accessToken,
  currentName,
