...
const describeMutationFailure = function describeMutationFailure(status?: number): string {
  if (status === 403) {
...
export const useUpdateAccount = function useUpdateAccount() {
...
export const useUpdateSetting = function useUpdateSetting<T = boolean>(
...
export const useGetSettings = function useGetSettings() {
  const router = useRouter()
...
export const useGetSettingsByUsername = function useGetSettingsByUsername() {
  const router = useRouter()
