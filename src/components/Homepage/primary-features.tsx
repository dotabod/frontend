...
import { CircleBackground } from 'src/components/circle-background'
import { Container } from 'src/components/container'
import { AppScreen } from 'src/components/Homepage/app-screen'
import { PhoneFrame } from 'src/components/Homepage/phone-frame'
...
const usePrevious = function usePrevious(value: number) {
