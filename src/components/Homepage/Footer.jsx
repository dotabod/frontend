    ...
    <footer className="border-t border-dark-500 bg-dark-900">
      <Container>
        <div className="flex flex-col items-start justify-between gap-y-12 pt-16 pb-6 lg:flex-row lg:items-center lg:py-16">
          ...
          <div className="group relative -mx-4 flex items-center self-stretch p-4 transition-colors hover:bg-dark-800 sm:self-auto sm:rounded-2xl lg:mx-0 lg:self-auto lg:p-6">
        ...
        <div className="flex flex-col items-center border-t border-dark-500 pt-8 pb-12 md:flex-row-reverse md:justify-between md:pt-6">
