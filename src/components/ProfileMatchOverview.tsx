...
function HeroOverview({ heroes, username }: { heroes: HeroPerformance[]; username: string }) {
...
function MatchOverview({ matches, username }: { matches: MatchHistoryRow[]; username: string }) {
...
export function ProfileMatchOverview({
  heroPerformance,
  recentMatches,
  username,
}: {
