      ...
      <Card className="p-0">
        <Accordion.Control>
          ...
          <div className="subtitle">
            Allows the Dotabod chat bot to type in your chat in case you ever
            turn on follower or subscribe mode.
          </div>
        </Accordion.Control>
        <Accordion.Panel>
          <div className="space-y-4 px-8 pb-8 text-sm text-dark-300">
            ...
            <div>
              2. <Badge>Optional</Badge> Add the following emotes to your
              channel using BTTV (case sensitive):
            </div>
