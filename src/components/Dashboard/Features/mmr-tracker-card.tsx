...
const MmrTrackerCard = () => (
  <Card title='MMR tracker'>
    ...
    <p className='text-xs'>
      Note: Since the 7.33 patch released on {new Date('2023-04-20').toLocaleDateString()}, Dotabod
      can no longer accurately estimate the MMR from each game. You can either use !setmmr or update
      it here after a game or after your stream. You can also have your mods do it for you via{' '}
      <Tag>!setmmr</Tag>
    </p>
  </Card>
)
