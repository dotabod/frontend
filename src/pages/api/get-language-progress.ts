...
const getTotalUsersForLanguage = async function getTotalUsersForLanguage(languageId: string) {
  try {
...
const fetchLanguageProgress = async function fetchLanguageProgress(_languageId: string) {
...
const fetchProject = async function fetchProject() {
