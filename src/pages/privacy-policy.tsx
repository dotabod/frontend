...
const PrivacyPolicy: NextPageWithLayout = () => (
  <Container className='py-24'>
    ...
    <ul>
      ...
      <li>
        <p>
          <strong>Application</strong> refers to Dotabod, the software program provided by the
          Company.
        </p>
      </li>
      <li>
        <p>
          ...
          &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Dotabod.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          ...
          <a href='dotabod.com' rel='noreferrer external nofollow noopener' target='_blank'>
            dotabod.com
          </a>
        </p>
      </li>
