    ...
    <div className='max-w-4xl mx-auto p-6 font-sans'>
      ...
      <section className='mb-6'>
        ...
        <p className=' text-sm leading-relaxed'>
          ...
          browser to browser, you should visit your browser's help menu for more information. Here
          are links for the most popular browsers:
        </p>
      ...
      <section className='mb-6'>
        ...
        <p className=' text-sm leading-relaxed'>
          ...
          effectiveness of advertisements. The information collected through this process does not
